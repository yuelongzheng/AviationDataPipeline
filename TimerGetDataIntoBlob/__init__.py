...
def convert_google_drive_links(url) :
...
def get_url_list(): 
    ...
    # Route_Distances.csv
    temp_url = 'https://drive.google.com/file/d/136Nqccr8Ru-2wGOjHNkv8ckkhVxi92MJ/view'
    url_list.append({
        'url' : convert_google_drive_links(temp_url),
        'filename' : 'Route_Distances.csv'
    })

    # AircraftType_PerRoute_ByAirline.csv
    temp_url = 'https://drive.google.com/file/d/1uJ9m0-8zODDlce9Z5aw9N0ZKanXnsBTC/view'
    url_list.append({
        'url' : convert_google_drive_links(temp_url),
        'filename' : 'AircraftType_PerRoute_ByAirline.csv'
    })

    # Aircraft_accident.csv
    temp_url = 'https://drive.google.com/file/d/1kKEYAXEXqXWqRDT9j5Xl6dX69Dr_BfSg/view'
    url_list.append({
        'url' : convert_google_drive_links(temp_url),
        'filename' : 'Aircraft_accident.csv'
    })      
